...
import './NewsCard.css';
import articleData from '../newsdata/carNews.json';
    ...
    <div>
      ...
      <div className="news-card-container">
        {articleData.map((article, index) => {
          const carInfo = article.CarInsuranceInformation;
              ...
              <div className="news-card-content">
                ...
                {isExpanded && (
                  <div className="news-expanded-content">
                    {sectionKeys.map((key) => {
                      const heading = carInfo[`heading${key}`];
                      const content = carInfo[`content${key}`];
                      return (
